...
export type GetLessonBySlugQuery = {
    ...
    lesson?: {
        ...
        teacher?: { __typename?: 'Teacher'; avatarURL: string; bio: string; name: string } | null;
    } | null;
};
...
export function useCreateSubscribeMutation(
    baseOptions?: Apollo.MutationHookOptions<CreateSubscribeMutation, CreateSubscribeMutationVariables>,
) {
